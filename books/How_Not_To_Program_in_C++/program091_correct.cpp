...
int main()
{
    std::vector<safe_stack> stack_vector;

    safe_stack s1, s2, s3, s4, s5;
    stack_vector.push_back(s1);
    //stack_vector.push_back(s2);
    //stack_vector.push_back(s3);
    //stack_vector.push_back(s4);
    //stack_vector.push_back(s5);

    //stack_array[0].push(0);
    //stack_vector[0].push(0);

    //stack_array[1].push(0);
    //stack_array[1].push(1);
    //stack_vector[1].push(0);
    //stack_vector[1].push(1);

    //stack_array[2].push(0);
    //stack_array[2].push(1);
    //stack_array[2].push(2);
    //stack_vector[2].push(0);
    //stack_vector[2].push(1);
    //stack_vector[2].push(2);

    //stack_array[3].push(0);
    //stack_array[3].push(1);
    //stack_array[3].push(2);
    //stack_array[3].push(3);
    //stack_vector[3].push(0);
    //stack_vector[3].push(1);
    //stack_vector[3].push(2);
    //stack_vector[3].push(3);
    ...
    //stack_vector[4].push(0);
    //stack_vector[4].push(1);
    //stack_vector[4].push(2);
    //stack_vector[4].push(3);
    //stack_vector[4].push(4);
